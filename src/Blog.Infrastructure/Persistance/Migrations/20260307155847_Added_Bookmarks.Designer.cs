...
namespace Blog.Infrastructure.Persistance.Migrations
{
    ...
    [Migration("20260307155847_Added_Bookmarks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Domain.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Blog.Domain.Reactions.ArticleClap", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<DateTime>("LastClappedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_clapped_at");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_article_claps");

                    b.HasIndex("ArticleId")
                        .HasDatabaseName("ix_article_claps_article_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_article_claps_user_id");

                    b.HasIndex("ArticleId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_article_claps_article_id_user_id");

                    b.ToTable("article_claps", (string)null);
                });

            modelBuilder.Entity("Blog.Domain.ReadingList.Bookmark", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ArticleId")
                        .HasDatabaseName("ix_bookmarks_article_id");
                    ...
                    b.HasIndex("UserId", "ArticleId")
                        .IsUnique()
                        .HasDatabaseName("ix_bookmarks_user_id_article_id");
            ...
            modelBuilder.Entity("Blog.Domain.Comments.Comment", b =>
                {
                    ...
                    b.HasOne("Blog.Domain.Users.Author", "Author")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_comments_author_author_id");

                    b.HasOne("Blog.Domain.Comments.Comment", "ParentComment")
                        .WithMany()
            ...
            modelBuilder.Entity("Blog.Domain.Reactions.ArticleClap", b =>
                {
                    b.HasOne("Blog.Domain.Articles.Article", "Article")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_article_claps_articles_article_id");
                    ...
                    b.HasOne("Blog.Domain.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_article_claps_user_user_id");
            ...
            modelBuilder.Entity("Blog.Domain.ReadingList.Bookmark", b =>
                {
                    b.HasOne("Blog.Domain.Articles.Article", "Article")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_bookmarks_articles_article_id");
                    ...
                    b.HasOne("Blog.Domain.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_bookmarks_user_user_id");
